      ...
      <div class="card mb-4">
        ...
        <div class="card-body demo-vertical-spacing demo-only-element">
          ...
          <div class="input-group">
            ...
            <input type="text" aria-label="First name" name="branch_prefix"  id="branch_prefix" value="{{ $branch->branch_prefix }}" class="form-control">
          ...
          <div class="input-group">
            ...
            <input type="text" aria-label="First name" name="address" id="address" value="{{ $branch->address }}" class="form-control">
         ...
         <!--  -->
          <div class="input-group">
            ...
            <input type="text" aria-label="First name" name="mobile_number" id="mobile_number" value="{{ $branch->mobile_number }}" class="form-control">

          </div>

          <div class="input-group">
            <span class="input-group-text">GST</span>
            <input type="text" aria-label="First name" name="GST" id="GST" value="{{ $branch->GST }}" class="form-control">

          </div>
          <div class="input-group">
            <span class="input-group-text">Org Name</span>
            <input type="text" aria-label="First name" name="org_name" id="org_name" value="{{ $branch->org_name }}" class="form-control">
