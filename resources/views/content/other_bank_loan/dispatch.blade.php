...
@section('content')
<h4 class="py-0 mb-4">
  <span class="text-muted fw-light" style="color:red !important;">Loan Dispatch</span>
</h4>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('loans.dispatchview', ['loan_number' => $loan->loan_number]) }}" title="edit"><i class="bx bx-pencil me-1"></i></a>
