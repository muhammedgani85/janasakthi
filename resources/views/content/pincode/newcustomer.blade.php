      ...
      <div class="card mb-4">
        ...
        <div class="card-body demo-vertical-spacing demo-only-element">
          ...
          <div class="input-group">
            ...
            <input type="text" aria-label="sandha_name name" name="name" id="name" class="form-control">

          </div>

          <div class="input-group">
            <span class="input-group-text">Tamil Name</span>
            <input type="text" aria-label="sandha_name name" name="name_tamil" id="name_tamil" class="form-control">
          ...
          <div class="input-group">
            ...
            <input type="text" aria-label="First name" name="pin_code" id="pin_code" class="form-control" maxlength="6" minlength="6">
